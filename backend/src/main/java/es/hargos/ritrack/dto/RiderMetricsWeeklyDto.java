...
@NoArgsConstructor
@AllArgsConstructor
public class RiderMetricsWeeklyDto {
    ...
    public static RiderMetricsWeeklyDto fromEntity(es.hargos.ritrack.entity.RiderMetricsWeeklyEntity entity) {
        return RiderMetricsWeeklyDto.builder()
