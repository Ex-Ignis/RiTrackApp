...
BEGIN
    ...
    RAISE NOTICE '';
    RAISE NOTICE 'Tenant schema tables (created per tenant):';
    RAISE NOTICE '  - rider_metrics_csv, rider_metrics_daily, rider_metrics_weekly';
    RAISE NOTICE '  - rider_block_status, auto_block_city_config';
    RAISE NOTICE '  - user_city_assignments, rider_limit_warnings';
    RAISE NOTICE '';
    RAISE NOTICE 'To configure a new tenant:';
    RAISE NOTICE '  1. HargosAuth creates tenant record in public.tenants';
    RAISE NOTICE '  2. User accesses RiTrack and completes onboarding';
    RAISE NOTICE '  3. POST /api/v1/tenant/onboarding/configure?tenantId=X';
    RAISE NOTICE '';
    RAISE NOTICE 'Tenant schemas are created dynamically during onboarding';
    RAISE NOTICE '========================================';
END $$;
